window.WORKING_FILE_DATA = {
  ...
  answers: [
    {
      ...
      links: [
        ...
        {label: "Read Logan's bio", href: "../bio.html"}
      ]
    },
    {
    ...
    },
    {
      ...
      keywords: ["process", "workflow", "broken", "review", "operations", "help"],
      answer: "Yes. The strongest submissions describe who uses the process, where it breaks, what workarounds exist, and what a good outcome would look like. Use the structured intake below to create a useful brief.",
      links: [
        {label: "Open process intake", href: "#broken-process"}
      ]
    },
    {
      title: "How did Wease Financial grow?",
      keywords: ["wease financial", "allstate", "2.8", "7.6", "agency story", "case study"],
      answer: "The public record on this site describes growth from $2.8M to $7.6M through acquisitions, stronger sales and training systems, and disciplined agency operations, followed by a profitable sale in 2021.",
      links: [
        {label: "Read the short bio", href: "../bio.html"}
      ]
    },
    {
  ...
  ideas: [
    ...
    {id: "playbook", title: "Steal My Playbook", note: "Release practical scorecards, checklists, and operating templates without a gated download."},
    {id: "office-hours", title: "Operator office hours", note: "Answer one submitted business or insurance problem each week in public."},
    {id: "failure-files", title: "Files That Did Not Work", note: "Document paused or failed projects with the original belief, cost, lesson, and possible return path."}
  ]
};